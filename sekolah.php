	...
	<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="sekolah.php">
                        Sekolah
                      </a>
      ...
      <div class="page-wrapper">
            ...
            <div class="row g-2 align-items-center">
              <div class="col">
			  	<ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
					...
					<li class="breadcrumb-item active" aria-current="page"><a href="sekolah.php">Master Sekolah</a></li>
				</ol>
              </div>
              <!-- Page title actions -->
			  <div class="col-auto ms-auto d-print-none">
				<div class="btn-list">
					<a href="#" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#inputsekolah">
				...
				<div class="modal" id="inputsekolah" tabindex="-1">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							...
							<form name="sekolahForm" action="savesekolah.php" method="post" class="needs-validation" novalidate> <!-- Moved <form> tag here -->
								<div class="modal-body">
									...
									<div class="mb-3">
										<label class="form-label">Rank Sekolah</label>
										<input type="text" class="form-control" name="rank_sekolah" placeholder="Rank Sekolah" required/>
										<div class="invalid-feedback">
											Rank Sekolah is required.
										</div>
									</div>
								</div>
								<div class="modal-footer">
									...
									<button class="btn btn-primary ms-auto" type="submit"> <!-- Removed data-bs-dismiss here -->
        ...
        <div class="page-body">
          ...
          <?php
              include "page.php";
              $nquery = mysqli_query($koneksi,"SELECT * FROM sekolah");
          ?>
            <form action="" method="post">
              ...
              class="table table-vcenter table-nowrap">
                  ...
                  ?>
                        <tr>
                          <td><?php echo $crow['id_sekolah']; ?></td>
                          <td><?php echo $crow['nama_sekolah']; ?></td>
                          <td><?php echo $crow['rank_sekolah']; ?></td>
                        </tr>
                  <?php $data++; } ?>
                  </tbody>
                </table>
