	...
	<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
      ...
      <div class="page-wrapper">
            ...
            <div class="row g-2 align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  ...
                  <a href="input.php" class="btn btn-primary d-none d-sm-inline-block">
        ...
        <div class="page-body">
          ...
          <?php
              include "page.php";
              $nquery = mysqli_query($koneksi,"SELECT * FROM ppdb_mhs");
          ?>
            <form action="" method="post">
              ...
              class="table table-vcenter table-nowrap">
                  ...
                  ?>
                        <tr>
                          <td><?php echo $crow['no_reg']; ?></td>
                          <td><?php echo $crow['nama_mhs']; ?></td>
                          <td><?php echo $crow['jenis_kelamin']; ?></td>
                          <td><?php echo $crow['bidikmisi']; ?></td>
                          <td><?php echo $crow['asal_sekolah']; ?></td>
                          <td><?php echo $crow['pilihan1']; ?></td>
                          <td><?php echo $crow['pilihan2']; ?></td>
                          <td><?php echo $crow['rank_sekolah']; ?></td>
                          <td><?php echo $crow['nilai_un']; ?></td>
                        </tr>
                  <?php $data++; } ?>
                  </tbody>
                </table>
